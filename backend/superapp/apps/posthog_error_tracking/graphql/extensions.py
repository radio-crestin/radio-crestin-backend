...
class PostHogErrorTrackingExtension(SchemaExtension):
    ...
    def _check_and_track_errors(self, phase: str):
        """Check execution context for errors and track them"""
        # Check for pre_execution_errors
    ...
    def on_execute(self):
        ...
        try:
            ...
            # Check for any errors in the execution context
    ...
    def on_operation_end(self):
        ...
        # Final check for any errors that might have been missed
