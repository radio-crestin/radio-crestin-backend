...
<div class="buttons">
  ...
  <a href="{{ google_play_url }}" class="store-button" style="display: inline-flex; align-items: center; padding: 11px 16px; background-color: #000; border-radius: 5px; text-decoration: none; color: white;">
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 48 48" style="margin-right: 12px;">
