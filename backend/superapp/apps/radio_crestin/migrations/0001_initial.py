    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
                'verbose_name': 'Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_seconds', models.IntegerField(default=0, verbose_name='Duration in seconds')),
                ('start_time', models.DateTimeField(verbose_name='Start time')),
                ('end_time', models.DateTimeField(blank=True, null=True, verbose_name='End time')),
                ('ip_address', models.GenericIPAddressField(blank=True, null=True, verbose_name='IP Address')),
                ('user_agent', models.TextField(blank=True, null=True, verbose_name='User Agent')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listening_events', to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listening_events', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
                'verbose_name': 'Listening Event',
                'verbose_name_plural': 'Listening Events',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='station_metadata_fetches', to='radio_crestin.stations', verbose_name='Station')),
                ('station_metadata_fetch_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='station_metadata_fetches', to='radio_crestin.stationmetadatafetchcategories', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='played_songs', to='radio_crestin.songs', verbose_name='Song')),
                ('station', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='now_playing', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='latest_for_stations', to='radio_crestin.stationsnowplaying', verbose_name='Latest Now Playing'),
        ),
        migrations.CreateModel(
            name='StationsUptime',
            fields=[
                ...
                ('raw_data', models.JSONField(verbose_name='Raw Data')),
                ('station', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='uptime', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='latest_for_stations', to='radio_crestin.stationsuptime', verbose_name='Latest Station Uptime'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='station_to_station_groups', to='radio_crestin.stationgroups', verbose_name='Group')),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='station_to_station_groups', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('stars', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Stars')),
                ('message', models.TextField(blank=True, null=True, verbose_name='Message')),
                ('verified', models.BooleanField(default=False, verbose_name='Verified')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='radio_reviews', to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
                'verbose_name': 'Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='station_streams', to='radio_crestin.stations', verbose_name='Station')),
            ],
            options={
